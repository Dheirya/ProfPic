var stickerbomb = (function(public) {
	...
	function insertInterface(container, instanceNum) {
		...
		if (!instance.hideTools || instance.hideTools.indexOf('delete') === -1) {
			makeTool('delete', 'Delete', 'fa-trash');
		}
	...
	public = function(args) {
		...
		makePopup(instanceNum, 'sb_loading', '<i class="fa fa-spinner faa-spin animated" style="font-size: 4rem;"></i><br><br>Loading stickers...');
